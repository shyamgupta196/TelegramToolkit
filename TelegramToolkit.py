...
if __name__ == '__main__':
	...
	parser.add_argument('-re', '--resolve-entities', dest='resolve_entity_flag', action='store_true',default = True, help='Resolve the entities in the raw Telegram data collection.')
	parser.add_argument('-ccg', '--create-channel-graph', dest='create_channel_graph_flag', action='store_true',default = True, help='Create the channel-to-channel graph from the Telegram data collection.')
	parser.add_argument('-cmc', '--create-message-chain', dest='create_message_chain_flag', action='store_true',default = True, help='Create the message chains of the messages from the Telegram data collection.')
	parser.add_argument('-ef', '--entity-frequency', dest='entity_frequency_flag', action='store_true',default = True, help='Compute the frequency of the entities on the whole data.')
	parser.add_argument('-eft', '--entity-frequency-type', dest='entity_frequency_type', action='store_true',default = True, help='The Telegram Toolkit will consider the entity type while computing the entity frequency. It only works with either \'-ef\' or \'--entity-frequency\' option.')
	parser.add_argument('-efc', '--entity-frequency-channel', dest='entity_frequency_channel_flag', action='store_true',default = True, help='Compute the frequency of the entities over channels.')
	parser.add_argument('-efct', '--entity-frequency-channel-type', dest='entity_frequency_channel_type', action='store_true',default = True, help='The Telegram Toolkit will consider the entity type while computing the entity frequency over channels. It only works with either \'-efc\' or \'--entity-frequency-channel\' option.')
	
	parser.add_argument('-gn', '--graph-name', dest='graph_name', default='channel_graph.json', action='store', help='Name of the graph created using the \'-ccg\' or \'--create-channel-graph\' option. Default: mygraph')
	parser.add_argument('-mcn', '--message-chain-name', dest='message_chain_name', default='message_chain.json', action='store', help='Name of the CSV file containing the information to which channels a message was forwarded to. It only works with either \'-cmc\' or \'--create-message-chain\' option. Default: my_message_chain')
	...
	parser.add_argument('-efs', '--entity-frequency-save', dest='entity_frequency_dest', default='entity_freq.json', action='store', help='The output file containing the entity frequency. It only works with either \'-ef\' or \'--entity-frequency\' option. Default: entity_frequency')
	...
	parser.add_argument('-efcs', '--entity-frequency-channel-save', dest='channel_entity_freq.json', default='entity_frequency_channels', action='store', help='The output file containing the entity frequency over channels. It only works with either \'-efc\' or \'--entity-frequency-channel\' option. Default: entity_frequency_over_channels')
